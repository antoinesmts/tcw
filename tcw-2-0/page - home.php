                ...
                <div class="card-columns">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur in iaculis justo. Sed in posuere.</p>
                            <p class="card-text"><small class="text-muted">Publié le <?php the_time('l, F jS, Y'); ?></small></p>
                        </div>
                    </div>
                    <?php endwhile; else: ?>
